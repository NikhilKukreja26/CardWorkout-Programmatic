...
class RulesVC: UIViewController {
    ...
    func configureRulesLabel() {
        ...
        rulesLabel.text = "The value of each exercise represents the number of exercise you do. \n\nJ = 11, Q = 12, K = 13, A = 14";
        ...
        NSLayoutConstraint.activate([
            rulesLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 75),
